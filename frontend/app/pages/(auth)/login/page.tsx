...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      position="top-right"
      />
    <div className="max-w-md w-full mx-auto p-6 space-y-6 w-1/2 flex items-center justify-center flex-col ">
      <div className="text-center space-y-2">
        <h1 className="text-2xl font-semibold">Welcome</h1>
        <p className="text-gray-500">Get started for a seamless shopping experience</p>
      </div> 
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <p className="text-center text-gray-600 text-sm">
          ...
          <Link href="/pages/register" className="text-pink-500 hover:text-pink-600">
            Register
          </Link>
        </p>
      </form>
